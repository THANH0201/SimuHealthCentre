...
public abstract class Engine {
    ...
    /**
     * Service Points are created in simu.simu.model-package's class inheriting the Engine class
     */
    public Engine() {
     ...
     * Defined in simu.simu.model-package's class who is inheriting the Engine class
     *
